package gin.oop.bomberman.entities.bomb;

import gin.oop.bomberman.Board;
import gin.oop.bomberman.Game;
import gin.oop.bomberman.entities.AnimatedEntitiy;
...
public class Bomb extends AnimatedEntitiy {
	...
	protected void explode() {
		...
		Sound.setSoundtackVolume(_sound.BOMB_BANG);
		_sound.play("BOMB_BANG");
