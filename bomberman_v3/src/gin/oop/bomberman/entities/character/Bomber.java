package gin.oop.bomberman.entities.character;
...
import gin.oop.bomberman.entities.tile.item.Item;
...
public class Bomber extends Character {
    ...
    protected void placeBomb(int x, int y) {
        ...
        Sound.setSoundEffectVolume(sound.BOMB);
        sound.play("BOMB");
    ...
    public void kill() {
        ...
        _alive = false;
        _board.addLives(-1);
        Sound.setSoundEffectVolume(_sound.BOMBER_DIE);
        _sound.play("BOMBER_DIE");
    }
