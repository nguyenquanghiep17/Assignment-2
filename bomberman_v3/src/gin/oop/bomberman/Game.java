...
public class Game extends Canvas {
	...
	private gin.oop.bomberman.gui.Frame _frame;
	...
	public Game(Frame frame) {
		...
		screen = new Screen(WIDTH, HEIGHT, frame);
		_input = new Keyboard();
	...
	public void start() {
		...
		while(_running) {
			...
			if (_input.pause) {
				_frame.pauseGame();
				Sound.setSoundtackVolume(_sound.PLAYGAME);
				_sound.pause("PLAYGAME");
			}
