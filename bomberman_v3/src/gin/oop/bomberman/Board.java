...
import gin.oop.bomberman.entities.bomb.Bomb;
import gin.oop.bomberman.entities.bomb.FlameSegment;
import gin.oop.bomberman.input.Keyboard;
import gin.oop.bomberman.level.FileLevelLoader;
import gin.oop.bomberman.level.LevelLoader;
...
import gin.oop.bomberman.graphics.IRender;
...
public class Board implements IRender {
	...
	private int _screenToShow = -1; //1:endgame, 2:changelevel, 3:pausede
...
//
	...
	public boolean isItemUsed(int x, int y, int _level) {
		return true;
	}
